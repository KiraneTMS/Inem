            ...
            <div class="card-body">
                <form action="{{ route('stocks.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="stock_1" name="stock_1" value="{{ old('stock_1') }}" />
                    </div>
                    <div class="form-group">
                        <label for="stock_2">{{ __('Stok 2') }}</label>
                        <input type="text" class="form-control" id="stock_2" name="stock_2" value="{{ old('stock_2') }}" />
                    </div>
                    <div class="form-group">
                        <label for="stock_3">{{ __('Stok 3') }}</label>
                        <input type="text" class="form-control" id="stock_3" name="stock_3" value="{{ old('stock_3') }}" />
                    </div>
                    <div class="form-group">
                        <label for="stock_4">{{ __('Stok 4') }}</label>
                        <input type="text" class="form-control" id="stock_4" name="stock_4" value="{{ old('stock_4') }}" />
                    </div>
                    <div class="form-group">
                        <label for="stock_5">{{ __('Stok 5') }}</label>
                        <input type="text" class="form-control" id="stock_5" name="stock_5" value="{{ old('stock_5') }}" />
                    </div>
                    <div class="form-group">
                        <label for="stock_6">{{ __('Stok 6') }}</label>
                        <input type="text" class="form-control" id="stock_6" name="stock_6" value="{{ old('stock_6') }}" />
                    </div>
                    <div class="form-group">
                        <label for="stock_7">{{ __('Stok 7') }}</label>
                        <input type="text" class="form-control" id="stock_7" name="stock_7" value="{{ old('stock_7') }}" />
                    </div>
